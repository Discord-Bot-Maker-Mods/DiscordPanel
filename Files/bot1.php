...
<head>
    <meta charset="utf-8" />
    <link rel="apple-touch-icon" sizes="76x76" href="https://discordapp.com/Template/assets/07dca80a102d4149e9736d4b162cff6f.ico" />
    <link rel="icon" href="/Template/assets/07dca80a102d4149e9736d4b162cff6f.ico" />
                        ...
                        <div class="col-md-8">
                            <div class="card">
                                <div class="card-header" data-background-color="purple">
                                    <h4 class="title"><?php echo $bot1; ?></h4>
                                </div>
                                <div class="card-content">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label>About <?php echo $bot1; ?></label>
                                                    <div class="form-group label-floating">
                                                        <label class="control-label"><?php echo $Bot1about; ?></label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="card card-profile">
                                <div class="card-avatar">
                                    <a href="#pablo">
                                        <img class="img" src="<?php echo $bot1image; ?>" />
                                    </a>
                                </div>
                                <div class="content">
                                    <h6 class="category text-gray"><?php echo $bot1; ?></h6>
                                    <h4 class="card-title"><?php echo $Bot1smalldetail; ?></h4>
                                    <a href="https://discordbots.org/bot/<?php echo $bot1ID; ?>" class="btn btn-primary btn-round">DISCORDBOTS URL</a>
                                </div>
                            </div>
                        </div>
                    </div>
