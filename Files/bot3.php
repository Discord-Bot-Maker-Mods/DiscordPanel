...
if(!empty($_POST['lobby-restart'])) { #Watch if the button is pressed
    $ssh->exec('cd /$bot3location; node bot.js'); #Execution in SSH
}
?>
<? 
                        ...
                        <div class="col-md-8">
                            <div class="card">
                                <div class="card-header" data-background-color="purple">
                                    <h4 class="title"><?php echo $bot3; ?></h4>
                                </div>
                                <div class="card-content">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label>About <?php echo $bot3; ?></label>
                                                    <div class="form-group label-floating">
                                                        <label class="control-label"><?php echo $Bot3about; ?></label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="card card-profile">
                                <div class="card-avatar">
                                    <a href="#pablo">
                                        <img class="img" src="<?php echo $bot3image; ?>" />
                                    </a>
                                </div>
                                <div class="content">
                                    <h6 class="category text-gray"><?php echo $bot3; ?></h6>
                                    <h4 class="card-title"><?php echo $bot3smalldetail; ?></h4>
                                    <a href="https://discordbots.org/bot/<?php echo $bot3ID; ?>" class="btn btn-primary btn-round">DISCORDBOTS URL</a>
                                </div>
                            </div>
                        </div>
                    </div>
