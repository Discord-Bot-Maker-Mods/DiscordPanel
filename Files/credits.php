...
.parent > ul {
  display: inline-block;
                                    ...
                                    <center><p>DiscordPanel was built using many free open source softwares and also by much help from the discord users who use discordpanel.
Here are the current helpers and software we have used to bring DiscordPanel to where it is currently today:</p>
<p>Software:</p>
<div class="parent">
<ul>
  <li>FontAwesome</li>
...
<div class="parent">
<ul>
  <li>BradersTheKiller</li>
  <li>Chaottiic</li>
  <li>Braders31</li>
  <li>SkittlesLover14</li>
  <li>General Wrex</li>
  <li>AHuman</li>
</ul></div> </center>
                        </div>
